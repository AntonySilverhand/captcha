...
def move_slide(self, offset_x, offset_y, left):
    ...
    pyautogui.moveTo(int(left * random.randint(15, 25) / 20), offset_y,
                     duration=0.1 + random.uniform(0, 0.1 + random.randint(1, 100) / 100))
    offset_y += random.randint(-9, 0)
    pyautogui.moveTo(int(left * random.randint(18, 22) / 20), offset_y,
                     duration=random.randint(19, 31) / 100)
    offset_y += random.randint(0, 8)
    pyautogui.moveTo(int(left * random.randint(19, 21) / 20), offset_y,
